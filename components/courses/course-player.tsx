...
export default function CoursePlayer({ course }: CoursePlayerProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 p-4 md:p-6 max-w-7xl mx-auto">
      
      {/* ✅ SIDEBAR */}
      <div className="md:col-span-1">
        <Card className="flex flex-col gap-2 max-h-[300px] md:max-h-full overflow-y-auto">
      ...
      <div className="md:col-span-3 flex justify-center">
        <div className="flex flex-col gap-6 w-full max-w-3xl">
          ...
          {/* ✅ Navigation (NOW CORRECT POSITION) */}
